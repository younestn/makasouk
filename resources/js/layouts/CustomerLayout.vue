    ...
    <header class="navbar">
      <div class="container">
        ...
        <nav class="nav-links" :aria-label="t('customers.navigation_aria')">
          ...
          <RouterLink class="nav-link" :to="{ name: 'customerActiveOrders' }">{{ t('common.active_orders') }}</RouterLink>
          <RouterLink class="nav-link" :to="{ name: 'customerOrderHistory' }">{{ t('common.history') }}</RouterLink>
        </nav>
