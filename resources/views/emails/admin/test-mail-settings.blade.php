...
<head>
    ...
    <title>{{ __('messages.mail.test_title', [], $locale) }}</title>
</head>
<body style="margin:0;background:#f7f3ea;font-family:{{ $isRtl ? 'Cairo, ' : '' }}Arial,sans-serif;color:#2b2118;">
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <h1 style="margin:0 0 12px;font-size:24px;line-height:1.3;">
                                {{ __('messages.mail.test_title', [], $locale) }}
                            </h1>
                            <p style="margin:0;color:#6f6255;line-height:1.8;">
                                {{ __('messages.mail.test_body', [], $locale) }}
                            </p>
                        </td>
                    </tr>
                </table>
